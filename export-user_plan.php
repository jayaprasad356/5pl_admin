...
$sql_query = "SELECT up.user_id, u.name AS user_name, u.mobile, up.plan_id, p.name AS plan_name, p.price, p.daily_codes, p.daily_earnings, p.per_code_cost, up.income, up.joined_date, up.claim
              FROM `user_plan` up
